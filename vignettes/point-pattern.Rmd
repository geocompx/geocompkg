...
```{r cycle-hire1, fig.cap="The spatial distribution of cycle hire points in London according to two datasets. One is from the cyclehireapp.com website (black); the other is from OpenStreetMap (red).", eval=FALSE}
plot(cycle_hire)
...
```{r zonedense, eval=FALSE, echo=FALSE}
