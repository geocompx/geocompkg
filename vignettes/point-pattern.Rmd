...
This vignette builds on the Raster-vector interactions section of Geocomputation with R (see [r.geocompx.org/geometric-operations.html#raster-vector](https://r.geocompx.org/geometric-operations.html#raster-vector)).
It shows the the basics of point pattern analysis in R and how to make (raster) 'heatmaps' from (vector) point data.
It is influenced by the chapter on Spatial Point Pattern Analysis [@bivand_applied_2013] and an [online tutorial](https://rspatial.org/analysis/rst/8-pointpat.html) on Point Pattern Analyis by Robert Hijmans.
...
- Try using other methods described in Robert Hijman's [tutorial](https://rspatial.org/analysis/rst/4-interpolation.html) on spatial interpolation.
