...
2. Compute all the predictor rasters we have used in the chapter (catchment slope, catchment area), and put them in a raster stack.
...
3. Retrieve the bias-reduced RMSE using spatial cross-validation including the estimation of optimal hyperparameter combinations (random search with 50 iterations) in an inner tuning loop (see [section](https://geocompr.robinlovelace.net/spatial-cv.html#svm)).
...
4. Retrieve the bias-reduced RMSE of a simple linear model using spatial cross-validation. 
