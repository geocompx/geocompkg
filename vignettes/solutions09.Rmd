...
4) Run `data(dem, package = "spDataLarge")` and `data(random_points, package = "spDataLarge")`.
...
5) Compute catchment area and catchment slope of `data("dem", package = "spDataLarge")` using **RSAGA**.
