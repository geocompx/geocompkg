...
This vignette provides a detailed description of inset map generation, building on the content in Section [Inset maps](http://geocompr.robinlovelace.net/adv-map.html#inset-maps) of [the Geocomputation with R book](https://geocompr.github.io/).
