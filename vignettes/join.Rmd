...
This vignette provides some further detail on the section Vector attribute joining (see https://geocompr.robinlovelace.net/attr.html#vector-attribute-joining ) of [the Geocomputation with R book](https://geocompr.github.io/).
...
Here, this is this simple because the geometry column is just another `data.frame` column and no longer the sticky geometry column of an `sf` object (see also the chapter [Geographic data in R](https://geocompr.robinlovelace.net/spatial-class.html)):
