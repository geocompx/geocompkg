...
5) Apply a line detection filter to `r = raster("https://www.r-project.org/logo/Rlogo.png")`.
Plot the result.
...
# just retrieve the first channel of the RGB R logo
r = raster("https://www.r-project.org/logo/Rlogo.png")
