...
You should already have an R installation set-up for spatial data analysis [having read Chapter 2 of Geocomputation with R](https://geocompr.robinlovelace.net/spatial-class.html).
...
That's topic of this workshop, as illustrated by the following GIF:
...
## Pitfall: Duplicate column names
